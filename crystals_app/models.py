...
class LaboratorySettingsExcel(models.Model):
	...
	pza_licor_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_licor_number = models.CharField(max_length=5, null=True, blank=True)
	pza_sirope_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_sirope_number = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_refino_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_refino_number = models.CharField(max_length=5, null=True, blank=True)
	pza_magma_b_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_magma_b_number = models.CharField(max_length=5, null=True, blank=True)
	pza_meladura_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_meladura_number = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_a_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_a_number = models.CharField(max_length=5, null=True, blank=True)
	pza_lavado_a_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_lavado_a_number = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_a_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_a_number = models.CharField(max_length=5, null=True, blank=True)
	pza_magma_c_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_magma_c_number = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_a_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_a_number = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_b_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_b_number = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_b_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_b_number = models.CharField(max_length=5, null=True, blank=True)
	pza_cr_des_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_cr_des_number = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_b_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_b_number = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_c_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_masa_c_number = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_c_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_nutsch_c_number = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_final_letter = models.CharField(max_length=5, null=True, blank=True)
	pza_miel_final_number = models.CharField(max_length=5, null=True, blank=True)

	bx_masa_c_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_c_number = models.CharField(max_length=5, null=True, blank=True)
	bx_cristal_des_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_cristal_des_number = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_c_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_c_number = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_b_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_b_number = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_a_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_a_number = models.CharField(max_length=5, null=True, blank=True)
	bx_magma_b_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_magma_b_number = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_refino_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_masa_refino_number = models.CharField(max_length=5, null=True, blank=True)
	bx_magma_c_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_magma_c_number = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_final_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_final_number = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_b_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_b_number = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_b_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_b_number = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_a_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_miel_a_number = models.CharField(max_length=5, null=True, blank=True)
	bx_lavado_a_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_lavado_a_number = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_a_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_nutsch_a_number = models.CharField(max_length=5, null=True, blank=True)
	bx_sirope_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_sirope_number = models.CharField(max_length=5, null=True, blank=True)
	bx_del_licor_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_del_licor_number = models.CharField(max_length=5, null=True, blank=True)
	bx_meladura_letter = models.CharField(max_length=5, null=True, blank=True)
	bx_meladura_number = models.CharField(max_length=5, null=True, blank=True)
	pol_azuc_letter = models.CharField(max_length=5, null=True, blank=True)
	pol_azuc_number = models.CharField(max_length=5, null=True, blank=True)
	sol_tota_hda_azu_letter = models.CharField(max_length=5, null=True, blank=True)
	sol_tota_hda_azu_number = models.CharField(max_length=5, null=True, blank=True)
	factory_id = models.IntegerField(default=1)
...
class LaboratoryData(models.Model):
	...
	pza_licor = models.CharField(max_length=10, null=True, blank=True)
	pza_sirope = models.CharField(max_length=10, null=True, blank=True)
	pza_masa_refino = models.CharField(max_length=10, null=True, blank=True)
	pza_magma_b = models.CharField(max_length=10, null=True, blank=True)
	pza_meladura = models.CharField(max_length=10, null=True, blank=True)
	pza_masa_a = models.CharField(max_length=10, null=True, blank=True)
	pza_lavado_a = models.CharField(max_length=10, null=True, blank=True)
	pza_nutsch_a = models.CharField(max_length=10, null=True, blank=True)
	pza_magma_c = models.CharField(max_length=10, null=True, blank=True)
	pza_miel_a = models.CharField(max_length=10, null=True, blank=True)
	pza_masa_b = models.CharField(max_length=10, null=True, blank=True)
	pza_nutsch_b = models.CharField(max_length=10, null=True, blank=True)
	pza_cr_des = models.CharField(max_length=10, null=True, blank=True)
	pza_miel_b = models.CharField(max_length=10, null=True, blank=True)
	pza_masa_c = models.CharField(max_length=10, null=True, blank=True)
	pza_nutsch_c = models.CharField(max_length=10, null=True, blank=True)
	pza_miel_final = models.CharField(max_length=10, null=True, blank=True)
	bx_masa_c = models.CharField(max_length=10, null=True, blank=True)
	bx_cristal_des = models.CharField(max_length=10, null=True, blank=True)
	bx_nutsch_c = models.CharField(max_length=10, null=True, blank=True)
	bx_masa_b = models.CharField(max_length=10, null=True, blank=True)
	bx_masa_a = models.CharField(max_length=10, null=True, blank=True)
	bx_magma_b = models.CharField(max_length=10, null=True, blank=True)
	bx_masa_refino = models.CharField(max_length=10, null=True, blank=True)
	bx_magma_c = models.CharField(max_length=10, null=True, blank=True)
	bx_miel_final = models.CharField(max_length=10, null=True, blank=True)
	bx_nutsch_b = models.CharField(max_length=10, null=True, blank=True)
	bx_miel_b = models.CharField(max_length=10, null=True, blank=True)
	bx_miel_a = models.CharField(max_length=10, null=True, blank=True)
	bx_lavado_a = models.CharField(max_length=10, null=True, blank=True)
	bx_nutsch_a = models.CharField(max_length=10, null=True, blank=True)
	bx_sirope = models.CharField(max_length=10, null=True, blank=True)
	bx_del_licor = models.CharField(max_length=10, null=True, blank=True)
	bx_meladura = models.CharField(max_length=10, null=True, blank=True)
	pol_azuc = models.CharField(max_length=10, null=True, blank=True)
	sol_tota_hda_azu = models.CharField(max_length=10, null=True, blank=True)
	factory_id = models.IntegerField(default=1)
